  ...
  const features = [
    {
      ...
      title: "Traceability",
      description: "Mechanism to track the origin of a drum, and the chain of distribution. This helps to ensure that the drum is safe and secure."
    },
    {
      image: img_tradeability,
      title: "Tradeability",
      description: "Mechanism to transfer a drum with other facilities. This helps to ensure that the drum is original and authentic."
    },
    {
      image: img_reputation_system,
      title: "Reputation System",
      description: `Mechanism to allow users to rate drum in order to build trust through reputation.`
    }
  ]
  return (
    <div className="middle-wrapper">
      <h5 className="mw-heading" >
        Stay <b>"Updated"</b> with Blockchain Powered End To End <b>"Nuclear Waste Management"</b> Platform.
      </h5>
