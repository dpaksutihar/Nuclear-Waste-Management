...
contract Stakeholder is Admin{
  ...
  function register(
    ...
    _stakeholders[msg.sender] = stakeholder(msg.sender, _name, _registration, _contact, _email, _certification, _location, _role, _managerName, _managerContact, false, false);
  ...
  function verify(address _id) public onlyAdmin returns (bool){
    ...
    function reject(address _id) public onlyAdmin returns (bool) {
        _stakeholders[_id].isVerified = false;
        _stakeholders[_id].isRejected = true; 
        return true;
    }
